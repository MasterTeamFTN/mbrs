...
public class HomeJspGenerator extends BasicGenerator {

    public HomeJspGenerator(GeneratorOptions generatorOptions) {
    ...
    public void generate() {
        ...
        try {
            ...
            Writer out = getWriter("homePage", "WEB-INF.jsp");
